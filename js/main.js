...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            lashing_hero_desc: "Explore our comprehensive catalog of certified marine lashing equipment, heavy-duty ratchet straps, forged steel turnbuckles, lashing chains, container twistlocks, dunnage air bags, and corner protectors, and watch field video demonstrations.",
        ...
        ar: {
            ...
            lashing_hero_desc: "استكشف الكتالوج الشامل لمعدات اللاشينج المعتمدة: أحزمة التثبيت عالية الشد، الشدادات الفولاذية، سلاسل التثبيت الثقيلة، أقفال الحاويات Twistlocks، أكياس التثبيت الهوائية، وواقيات الحواف والزوايا، ومشاهدة فيديوهات التثبيت الحية.",
